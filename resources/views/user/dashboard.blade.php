								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="form-check mb-3">
											<input class="form-check-input" type="checkbox" value="KEY" name="listDevice" disabled checked id="flexCheckDefault">
											<h6 class="form-check-label" for="flexCheckDefault">Chìa khóa</h6>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="checkbox" value="MIC" disabled checked id="flexCheckDefault">
											<h6 class="form-check-label" for="flexCheckDefault">Microphone</h6>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="checkbox" value="DKM" disabled checked id="flexCheckDefault">
											<h6 class="form-check-label" for="flexCheckDefault">Điều khiển máy chiếu</h6>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="checkbox" value="SPE" id="flexCheckDefault">
											<h6 class="form-check-label" for="flexCheckDefault">Loa</h6>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="checkbox" value="CAB" id="flexCheckDefault">
