...
(function(Ea, Q, k) {
    var P = function(h) {
        ...
        function P(a) {
            ...
            !a.sEmptyTable &&
                c &&
                "Không có dữ liệu để hiển thị" === b.sEmptyTable &&
                E(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords &&
                c &&
                "Đang tải..." === b.sLoadingRecords &&
        ...
        function jb(a) {
            ...
            for (c = l.length; b < c; b++)
                ...
                i && e.appendTo(d),
                a.oFeatures.bSort &&
                (e.addClass(f.sSortingClass), !1 !== f.bSortable &&
                    (e
                ...
                for (d = g.length; e < d; e++) {
                    ...
                    for (b = g[e].length; f < b; f++)
                        if (((o = i = 1), j[e][f] === k)) {
                            ...
                            for (
                                j[e][f] = 1; g[e + i] !== k && g[e][f].cell == g[e + i][f].cell;
        ...
        function mb(a) {
            ...
            for (
                var f = a.sDom.split(""), g, j, i, o, l, q, n = 0; n < f.length; n++
            ) {
                g = null;
                j = f[n];
                if ("<" == j) {
        ...
        function xb(a) {
            for (
                var b = m.ext.search, c = a.aiDisplay, e, d, f = 0, g = b.length; f < g; f++
            ) {
        ...
        function wb(a, b, c, e, d, f) {
            if ("" !== b)
                for (
                    var g = a.aiDisplay, e = Qa(b, e, d, f), d = g.length - 1; 0 <= d; d--
                )
        ...
        function Ib(a, b) {
            ...
            for (
                ...
                if (
                    ((c = a.aoData[j]),
                        c._aSortData || (c._aSortData = []), !c._aSortData[b] || e)
                )
        ...
        function Kb(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (
                    d &&
                    d.time &&
                    ((b = w(a, "aoStateLoadParams", "stateLoadParams", [a, d])), -1 === h.inArray(!1, b) &&
                        ((b = a.iStateDuration), !(0 < b && d.time < +new Date() - 1e3 * b) &&
        ...
        t.register = r = function(a, b) {
            if (h.isArray(a))
                ...
                for (
                    var d = a.split("."), f = Tb, g, j, c = 0, e = d.length; c < e; c++
                ) {
        ...
        var cb = function(a, b) {
            ...
            Vb = function(a, b) {
                ...
                if (c.length && a.length) {
                    ...
                    if (e._details) {
                        (e._detailsShow = b) ?
                        e._details.insertAfter(e.nTr): e._details.detach();
                        var d = c[0],
                            f = new t(d),
                            g = d.aoData;
                        f.off(
